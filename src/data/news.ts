...
const news: News = [
  {
    ...
    data: [
      { month: 9,
        details: [
          {day: 15, importance: "medium", summary: "お問い合わせページの削除", news: "お問い合わせやSNSに関しては自分のポートフォリオサイトから送られてくるよう集中管理した方が効率的だと判断したため削除しました。その代わりに私個人のポートフォリオサイトへのリンクをフッターに貼っておいたのでご確認ください。"}
        ]
      },
      {
        month: 8,
